...
public class DataUnit extends org.apache.thrift.TUnion<DataUnit, DataUnit._Fields> {
	...
	private static final org.apache.thrift.protocol.TField PERSON_PROPERTY_FIELD_DESC = new org.apache.thrift.protocol.TField(
			"person_property", org.apache.thrift.protocol.TType.STRUCT, (short) 1);
	...
	public enum _Fields implements org.apache.thrift.TFieldIdEnum {
		PERSON_PROPERTY((short) 1, "person_property"), PAGE_PROPERTY((short) 2, "page_property"), EQUIV((short) 3,
				"equiv"), PAGE_VIEW((short) 4, "page_view");
	...
	static {
		...
		tmpMap.put(_Fields.PERSON_PROPERTY,
				new org.apache.thrift.meta_data.FieldMetaData("person_property",
						org.apache.thrift.TFieldRequirementType.DEFAULT, new org.apache.thrift.meta_data.StructMetaData(
								org.apache.thrift.protocol.TType.STRUCT, PersonProperty.class)));
		tmpMap.put(_Fields.PAGE_PROPERTY,
				new org.apache.thrift.meta_data.FieldMetaData("page_property",
						org.apache.thrift.TFieldRequirementType.DEFAULT, new org.apache.thrift.meta_data.StructMetaData(
								org.apache.thrift.protocol.TType.STRUCT, PageProperty.class)));
		tmpMap.put(_Fields.EQUIV,
				new org.apache.thrift.meta_data.FieldMetaData("equiv", org.apache.thrift.TFieldRequirementType.DEFAULT,
						new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT,
								EquivEdge.class)));
		tmpMap.put(_Fields.PAGE_VIEW,
				new org.apache.thrift.meta_data.FieldMetaData("page_view",
						org.apache.thrift.TFieldRequirementType.DEFAULT, new org.apache.thrift.meta_data.StructMetaData(
								org.apache.thrift.protocol.TType.STRUCT, PageViewEdge.class)));
	...
	protected void checkType(_Fields setField, Object value) throws ClassCastException {
		...
		case PAGE_PROPERTY:
			...
			throw new ClassCastException("Was expecting value of type PageProperty for field 'page_property', but got "
					+ value.getClass().getSimpleName());
		case EQUIV:
			if (value instanceof EquivEdge) {
				break;
			}
			throw new ClassCastException("Was expecting value of type EquivEdge for field 'equiv', but got "
					+ value.getClass().getSimpleName());
		case PAGE_VIEW:
			if (value instanceof PageViewEdge) {
				break;
			}
			throw new ClassCastException("Was expecting value of type PageViewEdge for field 'page_view', but got "
					+ value.getClass().getSimpleName());
		default:
	...
	public PersonProperty getPerson_property() {
		if (getSetField() == _Fields.PERSON_PROPERTY) {
			...
			throw new RuntimeException("Cannot get field 'person_property' because union is currently set to "
	...
	public PageProperty getPage_property() {
		if (getSetField() == _Fields.PAGE_PROPERTY) {
			...
			throw new RuntimeException("Cannot get field 'page_property' because union is currently set to "
					+ getFieldDesc(getSetField()).name);
		}
	}
	...
	public EquivEdge getEquiv() {
		if (getSetField() == _Fields.EQUIV) {
			...
			throw new RuntimeException(
					"Cannot get field 'equiv' because union is currently set to " + getFieldDesc(getSetField()).name);
		}
	}
	...
	public PageViewEdge getPage_view() {
		if (getSetField() == _Fields.PAGE_VIEW) {
			...
			throw new RuntimeException("Cannot get field 'page_view' because union is currently set to "
					+ getFieldDesc(getSetField()).name);
		}
	}
