...
/**
 * A structured pail for Thrift objects Clase que modela una estructura para
 * serializar y deserializar datos. La clase generica permite usar la estructura
 * Pail para que sea usada por cualquier objeto Thrift
 */

@SuppressWarnings("rawtypes")
public abstract class ThriftPailStructure<T extends Comparable> implements PailStructure<T> {

	private static final long serialVersionUID = -990856380691243189L;

	/*
	 * The constructor of the Thrift object must be implemented in the child
	 * class.
	 */
