...
public class PropertyStructure implements FieldStructure {
	...
	/*
	 * Property is a Thrift struct containing a property value field; this is
	 * the ID for that field.
	 */
	...
	public PropertyStructure(Class prop) {
		try {
			...
			/*
			 * Parses the Thrift metadata to get the field ID of the property
			 * value
			 */
			...
			for (TFieldIdEnum valId : valMeta.keySet()) {
				/*
				 * Parses the metadata to get all valid field IDs of the
				 * property value
				 */
	...
	public boolean isValidTarget(String[] dirs) {
		/*
		 * The vertical partitioning of a property value has a depth of at least
		 * two.
		 */
		/*
		 * System.out.println("PropertyStructure.isValidTarget: ... INICIO");
		 * System.out.println("dirs: " + dirs.length); for(String val: dirs){
